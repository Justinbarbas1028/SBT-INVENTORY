      ...
      <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 space-y-6">
        ...
        <div className="pt-4 flex items-center space-x-4">
          <button 
            ...
            className="flex items-center space-x-2 px-6 py-2.5 bg-slate-800 text-white rounded-xl hover:bg-slate-700 transition-colors"
          >
            <QrCode size={18} />
        ...
        {generatedId && (
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200 mt-6 flex items-center justify-between">
            <div>
        ...
        <div className="pt-6 border-t border-slate-100">
          <button 
            ...
            className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Save size={18} />
